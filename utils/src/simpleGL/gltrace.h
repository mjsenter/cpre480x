...
enum GLID
{
    ...
    FP_glXCopyContext,
    FP_glXCreateContext,
    FP_glXCreateGLXPixmap,
    FP_glXDestroyContext,
    FP_glXDestroyGLXPixmap,
    FP_glXGetConfig,
    FP_glXGetCurrentContext,
    FP_glXGetCurrentDrawable,
    FP_glXIsDirect,
    FP_glXMakeCurrent,
    FP_glXQueryExtension,
    FP_glXQueryVersion,
    FP_glXSwapBuffers,
    FP_glXUseXFont,
    FP_glXWaitGL,
    FP_glXWaitX,
    FP_glXGetClientString,
    FP_glXQueryServerString,
    FP_glXQueryExtensionsString,
    FP_glXGetFBConfigs,
    FP_glXChooseFBConfig,
    FP_glXGetFBConfigAttrib,
    FP_glXGetVisualFromFBConfig,
    FP_glXCreateWindow,
    FP_glXDestroyWindow,
    FP_glXCreatePixmap,
    FP_glXDestroyPixmap,
    FP_glXCreatePbuffer,
    FP_glXDestroyPbuffer,
    FP_glXQueryDrawable,
    FP_glXCreateNewContext,
    FP_glXMakeContextCurrent,
    FP_glXGetCurrentReadDrawable,
    FP_glXGetCurrentDisplay,
    FP_glXQueryContext,
    FP_glXSelectEvent,
    FP_glXGetSelectedEvent,
    FP_glXGetContextIDEXT,
    FP_glXGetCurrentDrawableEXT,
    FP_glXImportContextEXT,
    FP_glXFreeContextEXT,
    FP_glXQueryContextInfoEXT,
	FP_glXGetProcAddressARB,
#endif
	FP_LAST
};
...
extern unsigned *indexQueue;
extern color_t *colorQueue;
extern vertex_t *vertexQueue;
extern unsigned indexQueueIndex;
extern unsigned vertexQueueIndex;
extern unsigned colorQueueIndex;

extern sgp_config *config;
extern unsigned int *simMemory;
